...
@Component({
  selector: 'app-viewtenent',
  templateUrl: './viewtenent.component.html'
})
export class ViewTenentComponent implements OnInit, OnDestroy {
  ...
  showAddNewModal() {
    this.router.navigate(['app/appproperty/tenent']);
  }

  ...
  @Component({
    selector: 'app-editsiteuser',
    templateUrl: './editsiteuser.component.html',
    styleUrls: ['./editsiteuser.component.scss']
  })
    ...
    agent
      ...
      Edit(id: any, value: any) {
        if (value == "view") {
          ...
          Object.keys(this.addSiteUserForm.controls).forEach(field => {
            this.addSiteUserForm.controls[field].disable();
          });
            ...
            Object.keys(this.addSiteUserForm.controls).forEach(field => {
              this.addSiteUserForm.controls[field].enable();
            });
        ...
        this.authService.GetUsersById(id).subscribe((result: any) => {
            ...
            if (finalresult) {
              ...
              this.addSiteUserForm.patchValue({
                operatorid: finalresult.operatorId || '',
                ...
                postalcode: finalresult.zipCode,  // Ensures boolean default
                microsoftAccount: finalresult.isMicrosoftAccount ?? false, // Ensures boolean default
                Active: finalresult.isActive ?? false // Ensures boolean default

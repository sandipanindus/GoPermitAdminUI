...
import { OperatorconfigRoutingModule } from './operatorconfig-routing.module';
...
@NgModule({
  declarations: [AddnewoperatoruserComponent, AddnewoperatordetailComponent,OperatotConfigComponent, OperatordetailstableComponent, EditoperatordetailComponent, OperatorusertableComponent, EditoperatoruserComponent],
  imports: [
    CommonModule,
    OperatorconfigRoutingModule,
     NgxSpinnerModule,

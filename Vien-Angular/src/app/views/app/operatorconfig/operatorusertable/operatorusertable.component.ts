   ...
   @Component({
    selector: 'app-operatorusertable',
    templateUrl: './operatorusertable.component.html',
    styleUrls: ['./operatorusertable.component.scss']
  })
   export class OperatorusertableComponent implements OnInit, OnDestroy {
     sitename = '';
     email = '';
     mobileno = '';
  ...
  agent
     ...
     GetSites() {
       ...
       this.authService.Getopeartoruser(this.currentPage, this.itemsPerPage, loginId, RoleId, SiteId).subscribe((result: any) => {
...
this.allsites=data.filter((item)=>item.isOperator==true)
     ...
     showAddNewModal() {
       this.router.navigate(['app/operatorconfig/addoperatoruser']);
     }
     ...
     showEditModal(id) {
       ...
       var objreq={
         ...
         RegisterUserId:parseInt(localStorage.getItem("LoginId")),
               RoleId:localStorage.getItem("RoleId"),
         Operation:"fetching all Operators for edit",
         Function:"Get Operatordetails for edit"
       }
           this.authService.Saveauditlog(objreq).subscribe((respone: any) => {
       
           })
       this.router.navigateByUrl('app/operatorconfig/editoperatoruser/' + id + '/' + value);
     }
     showViewModal(id) {
       var value = "view";
       this.router.navigateByUrl('app/operatorconfig/editoperatoruser/' + id + '/' + value);

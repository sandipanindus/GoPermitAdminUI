...
// },
{
  id: 'userconfig',
  icon: 'iconsminds-air-balloon-1',
  label: 'menu.userconfig',
  to: '/app/userconfig',
  subs: [{
    icon: 'simple-icon-user-following',
    label: 'menu.role',
    to: '/app/userconfig/role'
  },
  {
    icon: 'simple-icon-user-following',
    label: 'menu.user',
    to: '/app/userconfig/user'
  },
  {
    icon: 'simple-icon-user-following',
    label: 'menu.rolepermission',
    to: '/app/userconfig/rolepermission'
  }
  ]
},
// {
//   id: 'appconfig',
//   icon: 'iconsminds-air-balloon-1',
//   label: 'menu.appconfig',
//   to: '/app/appconfig',
//   subs: [{
//     icon: 'simple-icon-user-following',
//     label: 'menu.datasource',
//     to: '/app/appconfig/datasource'
//   },
//   {
//     icon: 'simple-icon-user-following',
//     label: 'menu.datatype',
//     to: '/app/appconfig/datatype'
//   },
//   {
//     icon: 'simple-icon-user-following',
//     label: 'menu.annotationtype',
//     to: '/app/appconfig/annotationtype'
//   }
//    ]
// },
{
  ...
  icon: 'iconsminds-air-balloon-1',
  label: 'menu.property',
  to: '/app/appproperty/viewproperty',
  // subs: [{
  //   icon: 'simple-icon-user-following',
  //   label: 'menu.property',
  //   to: '/app/appproperty/viewproperty'
  ...
  //   icon: 'simple-icon-user-following',
  //   label: 'menu.tenant',
  //   to: '/app/appproperty/viewtenent'
  // },
  // {
  //   icon: 'simple-icon-user-following',
  //   label: 'menu.vehicleregistration',
  //   to: '/app/appproperty/vehicle-registration'
  // }
   //]
},
{
